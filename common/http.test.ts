    ...
    describe('Feature: Create HTTP Request', () => {
      ...
      describe('Scenario: Creating requests with different HTTP methods', () => {
        test.each([
          ...
          'Given HTTP method %s and token, When createHttpRequest is called, Then it should return a request object with correct method',
          (method, token) => {
      ...
      describe('Scenario: Handling null or undefined data', () => {
        test.each([
          ...
          'Given data is %s, When createHttpRequest is called, Then body should be an empty string',
          (data, expectedBody) => {
            const httpMethod = 'POST';
